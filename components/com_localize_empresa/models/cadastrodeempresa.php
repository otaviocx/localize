 ...
 */
class Localize_empresaModelCadastrodeempresa extends JModelItem
{
	...
	public function &getData($id = null)
	{
		...
		if ( isset($this->_item->corretores) ) {
			$this->_item->corretores_name = JFactory::getUser($this->_item->corretores)->name;
		}
